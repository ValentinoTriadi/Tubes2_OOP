...
public class AudioManager {
    ...
    // Method to mute
    public void mute() {
        handleMute(instance.backgroundMusicPlayer, instance.backgroundMusicVolume, volumeBGMBeforeMute);
        handleMute(instance.sfxPlayer, instance.sfxVolume, volumeSFXBeforeMute);
